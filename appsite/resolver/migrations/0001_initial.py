# Generated by Django 2.2.6 on 2020-01-14 21:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('added', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('organization', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='publishers', to='resolver.Organization')),
                ('parent', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='resolver.Publisher')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('added', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('parent', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='resolver.EntryPoint')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('added', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('entrypoints', models.ManyToManyField(default=None, to='resolver.EntryPoint')),
            ],
            options={
