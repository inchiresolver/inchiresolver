# Generated by Django 2.2.11 on 2020-06-12 08:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='resolver.Organization')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request_methods', multiselectfield.db.fields.MultiSelectField(choices=[('GET', 'GET'), ('POST', 'POST')], default=['GET'], max_length=8)),
                ('description', models.TextField(blank=True, max_length=32768, null=True)),
