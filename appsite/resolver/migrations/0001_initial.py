# Generated by Django 2.2.11 on 2020-07-23 21:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('added', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('accept_header_mediatypes', models.ManyToManyField(related_name='accepting_endpoints', to='resolver.MediaType')),
                ('content_mediatypes', models.ManyToManyField(related_name='delivering_endpoints', to='resolver.MediaType')),
