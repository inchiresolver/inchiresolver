...
class TaggedItemDRFSerializer(drf_serializer.ModelSerializer):
    """
...
class BlogSerializer(serializers.ModelSerializer):
    ...
    include_serializers = {
        'tags': 'sandbox.serializers.TaggedItemSerializer',
    }
...
class BlogDRFSerializer(drf_serializer.ModelSerializer):
    """
    DRF default serializer to test default DRF functionalities
    """
    copyright = serializers.SerializerMethodField()
...
class EntrySerializer(serializers.ModelSerializer):
    ...
    included_serializers = {
        'authors': 'sandbox.serializers.AuthorSerializer',
        'comments': 'sandbox.serializers.CommentSerializer',
        'featured': 'sandbox.serializers.EntrySerializer',
        'suggested': 'sandbox.serializers.EntrySerializer',
        'tags': 'sandbox.serializers.TaggedItemSerializer',
    }
...
class EntryDRFSerializers(drf_serializer.ModelSerializer):

    tags = TaggedItemDRFSerializer(many=True, read_only=True)
    url = drf_serializer.HyperlinkedIdentityField(
...
class AuthorBioSerializer(serializers.ModelSerializer):
    ...
    included_serializers = {
        'metadata': 'sandbox.serializers.AuthorBioMetadataSerializer',
    }
...
class AuthorSerializer(serializers.ModelSerializer):
    ...
    related_serializers = {
        'bio': 'sandbox.serializers.AuthorBioSerializer',
        'type': 'sandbox.serializers.AuthorTypeSerializer',
        'comments': 'sandbox.serializers.CommentSerializer',
        'entries': 'sandbox.serializers.EntrySerializer',
        'first_entry': 'sandbox.serializers.EntrySerializer'
    }
